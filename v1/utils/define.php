...
$firstDomain = "https://scrapingdeveloper2.000webhostapp.com/$pathFileApiScraping";
$secondDomain = "https://scrapingdevelop.000webhostapp.com/$pathFileApiScraping";
$thirdDomain = "https://scrapingdevelop3.000webhostapp.com/$pathFileApiScraping";
$thirdDomain = "http://localhost:8888/restapi/v1/$pathFileApiScraping";

$pathFileApiTranslator = "translator?";
$firstDomainTranslator = "https://scrapingdeveloper2.000webhostapp.com/$pathFileApiTranslator";
$secondDomainTranslator = "https://scrapingdevelop.000webhostapp.com/$pathFileApiTranslator";
$thirdDomainTranslator = "https://scrapingdevelop3.000webhostapp.com/$pathFileApiTranslator";
$thirdDomainTranslator = "http://localhost:8888/restapi/v1/$pathFileApiTranslator";


$pathFileApiHttGet = "handler_api?";
$firstDomainHttGet = "https://scrapingdeveloper2.000webhostapp.com/$pathFileApiHttGet";
$secondDomainHttGet = "https://scrapingdevelop.000webhostapp.com/$pathFileApiHttGet";
// $thirdDomainHttGet = "https://scrapingdevelop3.000webhostapp.com/$pathFileApiHttGet";
