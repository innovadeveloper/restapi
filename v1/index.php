<?php
/**
 * More info : http://www.weblantropia.com/2016/08/30/restful-api-api-php-mysql/
 * @About:      API Interface
 * @File:       index.php
 * @Date:       $Date:$ Nov-2015
 * @Version:    $Rev:$ 1.0
...
/*********************** USEFULL FUNCTIONS (COMPARTIDAS PARA TODAS LAS CLASES)**************************************/
/**
 ...
 * @param Int $response Json response
 */
function echoResponseHtml($status_code, $response) {
    $app = \Slim\Slim::getInstance();
    // Http response code
    $app->status($status_code);
    // setting response content type to json
